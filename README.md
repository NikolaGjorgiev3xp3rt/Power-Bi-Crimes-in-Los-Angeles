...
- Examine crime distribution by location and area
...
- Geographic location (area / district)
- Victim-related attributes (where available)
- Crime frequency and trends
...
- **DAX Measures** – KPIs and aggregations
...
- Seasonal and time-based trends are visible in crime occurrences
- Visualization helps identify high-risk locations and periods
